...
int div8(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int div16(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int div32(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int div64(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
