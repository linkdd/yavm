...
int sub8(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int sub16(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int sub32(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int sub64(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
