...
int inc8(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int inc16(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int inc32(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int inc64(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
