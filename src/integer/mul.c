...
int mul8(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int mul16(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int mul32(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int mul64(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
