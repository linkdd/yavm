...
int add8(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int add16(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int add32(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int add64(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
