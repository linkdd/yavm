...
int mod8(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int mod16(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int mod32(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
...
int mod64(instruction_t *instr, stack_t *stack)
{
    int bytes = 0;
